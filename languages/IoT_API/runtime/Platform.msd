...
<solution name="Platform" uuid="3539fa5b-8b82-42a7-8b23-1d5d027e4376" moduleVersion="0" compileInMPS="true">
  <models>
    <modelRoot contentPath="${module}" type="default">
      <sourceRoot location="models" />
    </modelRoot>
    <modelRoot contentPath="${module}" type="java_classes">
      <sourceRoot location="lib/joou-0.9.1.jar" />
    </modelRoot>
  </models>
  <stubModelEntries>
    <stubModelEntry path="${module}/lib/joou-0.9.1.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
